      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form class="user" method="post" action="">
            <?php
              $empid=$_SESSION['uid'];
              $ret=mysqli_query($con,"SELECT * FROM emp_exp WHERE EmpID='$empid'");
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="emp1name" name="emp1name" aria-describedby="emailHelp" value="<?php  echo $row['Employer1Name'];?>">
              </div>
            </div>  
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="emp1des" name="emp1des" aria-describedby="emailHelp" value="<?php  echo $row['Employer1Designation'];?>">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">
                <input type="text" class="form-control form-control-user" id="emp1ctc" name="emp1ctc" aria-describedby="emailHelp" value="<?php  echo $row['Employer1CTC'];?>">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="emp2name" name="emp2name" aria-describedby="emailHelp" value="<?php  echo $row['Employer2Name'];?>">
              </div>
            </div>  
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="emp2des" name="emp2des" aria-describedby="emailHelp" value="<?php  echo $row['Employer2Designation'];?>">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">
                <input type="text" class="form-control form-control-user" id="emp2ctc" name="emp2ctc" aria-describedby="emailHelp" value="<?php  echo $row['Employer2CTC'];?>">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="emp3name" name="emp3name" aria-describedby="emailHelp" value="<?php  echo $row['Employer3Name'];?>">
              </div>
            </div>  
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="emp3des" name="emp3des" aria-describedby="emailHelp" value="<?php  echo $row['Employer3Designation'];?>">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">
                <input type="text" class="form-control form-control-user" id="emp3ctc" name="emp3ctc" aria-describedby="emailHelp" value="<?php  echo $row['Employer3CTC'];?>">
              </div>
            </div>
          ...
          <div class="row" style="margin-top:4%">
            <div class="col-12" style="font-size:18px; color:red;">
              First Add Your Experience Details After That You Can Edit Experience Details.
            </div>       
          </div>
