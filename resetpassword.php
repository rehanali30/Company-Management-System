...
else
{
  if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con,"UPDATE emp_detail SET EmpPassword='$password' WHERE  EmpEmail='$email' && EmpCode='$empid'");
    if($query)
    {
...
<head>
  ...
  <meta name="viewport" content="Company Management System">
