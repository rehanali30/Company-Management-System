    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <?php 
            $empid=$_SESSION['uid'];
            $query=mysqli_query($con,"SELECT * FROM emp_edu WHERE EmpID=$empid");
            $row=mysqli_fetch_array($query);
            if($row>0)
            {

          ?>
          <p style="font-size:16px; color:grey" align="center">Your Education details already added. Now you can only edit the record. </p>
          ...
          <form class="user" method="post" action="">
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">   
                <input type="text" class="form-control form-control-user" id="coursepg" name="coursepg" aria-describedby="emailHelp" value="">
              </div>
            </div>  
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="schoolclgpg" name="schoolclgpg" aria-describedby="emailHelp" value="">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">   
                <input type="text" class="form-control form-control-user" id="coursegra" name="coursegra" aria-describedby="emailHelp" value="" required="true">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3"> 
                <input type="text" class="form-control form-control-user" id="schoolclggra" name="schoolclggra" aria-describedby="emailHelp" value="" required="true">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">
                <input type="text" class="form-control form-control-user" id="yopgra" name="yopgra" aria-describedby="emailHelp" value="" required="true">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">   
                <input type="text" class="form-control form-control-user" id="coursessc" name="coursessc" aria-describedby="emailHelp" value="" required="true">
              </div>
            </div>  
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3"> 
                <input type="text" class="form-control form-control-user" id="schoolclgssc" name="schoolclgssc" aria-describedby="emailHelp" value="" required="true">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">
                <input type="text" class="form-control form-control-user" id="yopssc" name="yopssc" aria-describedby="emailHelp" value="" required="true">
              </div>
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">   
                <input type="text" class="form-control form-control-user" id="coursehsc" name="coursehsc" aria-describedby="emailHelp" value="" required="true">
              </div>
            </div>  
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">  
                <input type="text" class="form-control form-control-user" id="schoolclghsc" name="schoolclghsc" aria-describedby="emailHelp" value="" required="true">
              </div>  
            </div>
            ...
            <div class="row">
              ...
              <div class="col-8 mb-3">
                <input type="text" class="form-control form-control-user" id="yophsc" name="yophsc" aria-describedby="emailHelp" value="" required="true">
              </div>
            </div>
