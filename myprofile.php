...
else
{
  ...
  { 
    ...
    $query=mysqli_query($con, "UPDATE emp_detail SET EmpFname='$FName',  EmpLName='$LName', EmpCode='$empcode', EmpDept='$EmpDept', EmpDesignation='$EmpDesignation', EmpContactNo='$EmpContactNo', EmpGender='$gender',EmpJoingdate='$empjdate' WHERE ID='$eid'");
    if ($query) {
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <form class="user" method="post" action="">
            <?php
              $eid=$_SESSION['uid'];
              $ret=mysqli_query($con,"SELECT * FROM emp_detail WHERE ID='$eid'");
